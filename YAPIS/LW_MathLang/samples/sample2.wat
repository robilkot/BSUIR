(module
  ...
  (memory $memory 1)
  ;; String constants
  (data (i32.const 1) "\"Calculating sine wave values from 0 to 2*PI:\n\"\00")
  (data (i32.const 50) "\"sin(\"\00")
  (data (i32.const 57) "\") = \"\00")
  (data (i32.const 64) "\"\n\"\00")
  (data (i32.const 69) "\"\nFinding solution for sin(x) = 0.5\n\"\00")
  (data (i32.const 109) "\"Solution found: x = \"\00")
  (data (i32.const 132) "\", sin(x) = \"\00")
  (data (i32.const 146) "\"sin^2(x) + cos^2(x) = \"\00")
