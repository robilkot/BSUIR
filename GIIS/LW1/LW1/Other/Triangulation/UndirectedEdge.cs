...
{
    public partial class DelaunayTriangulationAlgorithm
    {
        private record struct UndirectedEdge(Point A, Point B);

        private class UndirectedEdgeComparer : IEqualityComparer<UndirectedEdge>
        {
