    ...
    public class MainWindowViewModel : ViewModelBase
    {
        ...
        public MainWindowViewModel()
        {
            ...
            Texts = [
                ...
                new() {
                    Text = "Эй, вы все, поступайте на ФИТУ! Тут классно и очень весело, правда, очень весело. Не обманываю вас, потому что я сам студент этого замечательного факультета."
                }
                ];
        }
